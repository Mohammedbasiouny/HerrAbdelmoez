...
<section class="flex">
   ...
   <div class="icons">
      ...
      <div id="search-btn" class="fas fa-search" alt="Search"></div>
      <div id="user-btn" class="fas fa-user" alt="User"></div>
      <div id="toggle-btn" class="fas fa-sun" alt="Toggle"></div>
   </div>
...
<aside class="side-bar">
   <div id="close-btn">
      <i class="fas fa-times" alt="Close"></i>
   </div>
   ...
   <nav class="navbar">
      ...
      <a href="contact.php"><i class="fas fa-headset" alt="Contact Us"></i><span>Contact Us</span></a>
   </nav>
</aside>
